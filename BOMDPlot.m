...
for curr_chart = 1:NCharts
    ...
    text(1.2,m_data{1}(curr_chart),num2str(100*m_data{1}(curr_chart),'%4.0f'),...
    ...
    if Ninputs > 1
        for curr_plot = 2:Ninputs
            ...
            text(curr_plot + 0.2,m_data{curr_plot}(curr_chart),num2str(100*m_data{curr_plot}(curr_chart),'%4.0f'),...
                'VerticalAlignment','middle','fontsize',AxisFont)
        end
    end
    hold off
    ...
    if curr_chart == 1
        ...
        line([XRange(1)-.1 XRange(1)+.1],[1 1]*.5,...
            'linewidth',ThinLineWidth,'color',gray_line);
        text(XRange(1),.5,num2str(50),...
            'HorizontalAlignment','right',...
            'color',gray_line,...
            'fontsize',LegendFont)
        line([XRange(1)-.1 XRange(1)+.1],[1 1]*0,...
            'linewidth',ThinLineWidth,'color',gray_line);
        text(XRange(1),0,num2str(0),...
            'HorizontalAlignment','right',...
            'color',gray_line,...
            'fontsize',LegendFont)
        line([XRange(1)-.1 XRange(1)+.1],[1 1],...
            'linewidth',ThinLineWidth,'color',gray_line);
        text(XRange(1),1,num2str(100),...
            'HorizontalAlignment','right',...
            'color',gray_line,...
            'fontsize',LegendFont)
    end
    ...
    text(mean(XRange),0,['p < ' num2str(PValues(curr_chart),'%0.3f')],...
        'fontsize',LegendFont,...
