...
infomap_command_file=/mnt/max/shared/code/internal/utilities/simple_infomap/simple_infomap.py # the path and filename of the simple_infomap python function built by Damion Demeter
fdapath='/mnt/max/shared/code/external/utilities/fdaM/' # the path to the fda repository developed by Jim Ramsay
infomapfile='/mnt/max/shared/utilities/infomap/Infomap' # the path to the Infomap command used to run infomap.
repopath='/mnt/max/shared/projects/FAIR_users/Feczko/code_in_dev/RFAnalysis/' # the path to the FRF repository.
