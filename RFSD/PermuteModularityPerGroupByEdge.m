function [observed_modularity,modularity_p] = PermuteModularityPerGroupByEdge(varargin)
...
for curr_density = lowdensity:stepdensity:highdensity
    observed_modularity(:,col_count) = CalculateModularityPerGroup(adj_mat,modules,'EdgeDensity',edgedensity);
